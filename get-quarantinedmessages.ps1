...
$Report | Group-Object Type | Sort-Object Count -Descending | Format-Table Name, Count

Write-Host "Messages quarantined per recipient address"
$Report | Group-Object Recipient | Sort-Object Count -Descending | Format-Table Name, Count

Write-Host "Problem domains"
$Report | Group-Object SenderDomain |Sort-Object Count -Descending | Format-Table Name, Count

Write-Host "High confidence Phishing Messages"
$Report | Where-Object {$_.Type -eq "HighConfPhish"} | Format-Table Received, Recipient, Sender, Subject
